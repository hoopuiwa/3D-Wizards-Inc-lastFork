...
const mechdragon: Product = {
  ...
  thirdColor: [],
  price: '$25',
  image: '/images/Products/mechanical_dragon_blk_1.jpg', // array of images depending on the color selected
  size: {
  ...
  return (
    <Container fluid>
      <Row className="mt-4">
        ...
        {/* Details Section */}
        <Col md={6}>
          <h1>{mechdragon.name}</h1>
          <h2>{mechdragon.price}</h2>
          <hr />
