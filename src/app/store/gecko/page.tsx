...
const gecko: Product = {
  ...
  thirdColor: [],
  price: '$20',
  image: '/images/Products/gecko.jpg', // array of images depending on the color selected
  size: {
      ...
      <Row className="mt-4">
        ...
        <Col md={6}>
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <input type="hidden" {...register('option')} value="GECKO" />
